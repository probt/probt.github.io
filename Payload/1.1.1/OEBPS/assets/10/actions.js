 ...
 * 
 */
var obj1088_onLoad_activeActionGroupIndex = -1;
var obj1088_onLoad_runningActionsCount = 0;
var obj1088_onLoad_loopCount = 0;
...
obj1088_onLoad_actionGroup0 = function(){
	isLastActionGroup = false;
	if (isLastActionGroup) {
		window.obj1088_onLoad_activeActionGroupIndex = -1;
		$("#obj1088").trigger("obj1088_onLoad_ended");
		
		return;
	}
	window.obj1088_onLoad_activeActionGroupIndex = 0;
...
//	target: obj1088 
rotate_1091();
function rotate_1091() {
	window.obj1088_onLoad_runningActionsCount = obj1088_onLoad_runningActionsCount + 1;
	
	var targetObjectId = "#obj1088";
	var targetObject = $(targetObjectId)[0];
	var targetObjectIdString = 'obj1088';
	...
	if (isInfinite) { rotate_1091_completed(); }
	//TweenMax.to(targetObjectId, 1, {rotation:'+=' + rotationToDegrees, transformOrigin: transformOriginX + ' ' + transformOriginY, ease:'' + rotationEasing + '', repeat:0, onComplete:rotate_1091_completed});
	
	var timesRun = 0;
	timesRun += 1;
	rotate(targetObjectIdString,timesRun,howManyTimes,rotationToDegrees,rotationSpeedMS,rotationEasing,transformOriginX,transformOriginY,rotate_1091_completed);
...
function rotate_1091_completed() {
	setTimeout(function() {
		window.obj1088_onLoad_runningActionsCount = window.obj1088_onLoad_runningActionsCount - 1;
if (window.obj1088_onLoad_runningActionsCount == 0) {
	obj1088_onLoad_actionGroup1();
}
	}, 1);
}
...
function scale_1092() {
	...
	var isInfinite = false;
	if (isInfinite) { 
		scale_1092_completed(); 
	}
		var timesRun = 0;
	timesRun += 1;
	scale(targetObjectIdString,timesRun,howManyTimes,scaleXValue,scaleYValue,effectDurationMS,effectEasing,transformOriginX,transformOriginY,scaleMode,scale_1092_completed);
	if (howManyTimes > 1 || isInfinite) {
...
obj1088_onLoad_actionGroup1 = function(){
	isLastActionGroup = false;
	if (isLastActionGroup) {
		window.obj1088_onLoad_activeActionGroupIndex = -1;
		$("#obj1088").trigger("obj1088_onLoad_ended");
...
function rotate_1093() {
	...
	var isInfinite = false;
	if (isInfinite) { rotate_1093_completed(); }
	//TweenMax.to(targetObjectId, 1.5, {rotation:'+=' + rotationToDegrees, transformOrigin: transformOriginX + ' ' + transformOriginY, ease:'' + rotationEasing + '', repeat:0, onComplete:rotate_1093_completed});
	
	var timesRun = 0;
	timesRun += 1;
	rotate(targetObjectIdString,timesRun,howManyTimes,rotationToDegrees,rotationSpeedMS,rotationEasing,transformOriginX,transformOriginY,rotate_1093_completed);
	if (howManyTimes > 1 || isInfinite) {
		var rotateInterval = setInterval(function(){
			timesRun += 1;
			rotate(targetObjectIdString,timesRun,howManyTimes,rotationToDegrees,rotationSpeedMS,rotationEasing,transformOriginX,transformOriginY,rotate_1093_completed);
...
function rotate_1093_completed() {
	setTimeout(function() {
		window.obj1088_onLoad_runningActionsCount = window.obj1088_onLoad_runningActionsCount - 1;
if (window.obj1088_onLoad_runningActionsCount == 0) {
	obj1088_onLoad_actionGroup2();
}
	}, 1);
}
...
function scale_1094() {
	...
	var isInfinite = false;
	if (isInfinite) { 
		scale_1094_completed(); 
	}
		var timesRun = 0;
	timesRun += 1;
	scale(targetObjectIdString,timesRun,howManyTimes,scaleXValue,scaleYValue,effectDurationMS,effectEasing,transformOriginX,transformOriginY,scaleMode,scale_1094_completed);
	if (howManyTimes > 1 || isInfinite) {
		var scaleInterval = setInterval(function(){
			timesRun += 1;
				scale(targetObjectIdString,timesRun,howManyTimes,scaleXValue,scaleYValue,effectDurationMS,effectEasing,transformOriginX,transformOriginY,scaleMode,scale_1094_completed);
...
obj1088_onLoad_actionGroup2 = function(){
	isLastActionGroup = false;
	if (isLastActionGroup) {
		window.obj1088_onLoad_activeActionGroupIndex = -1;
		$("#obj1088").trigger("obj1088_onLoad_ended");
	...
	window.obj1088_onLoad_activeActionGroupIndex = 2;
...
//	action: loop
loop_obj1088_onLoad();
function loop_obj1088_onLoad() {
	var loopCount = 0;
	window.obj1088_onLoad_loopCount = window.obj1088_onLoad_loopCount + 1;
	if (loopCount != 0 && window.obj1088_onLoad_loopCount > loopCount) {
		window.obj1088_onLoad_loopCount = 0
		obj1088_onLoad_actionGroup3();
	} else {
		obj1088_onLoad_actionGroup0();
	}
}
...
obj1088_onLoad_actionGroup3 = function(){
	...
	window.obj1088_onLoad_activeActionGroupIndex = 3;
...
$(window).bind(PubCoder.Events.PageReady, function(event) {
	if (window.obj1088_onLoad_activeActionGroupIndex != -1) return;
var obj1088_onLoad_runningActionsCount = 0;
var obj1088_onLoad_loopCount = 0;
obj1088_onLoad_actionGroup0();
});
