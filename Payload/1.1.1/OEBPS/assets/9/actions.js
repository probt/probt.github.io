...
pubcoder.page.id = pubcoder.page.id || 38;
 ...
 * 
 */
var obj1080_onLoad_activeActionGroupIndex = -1;
var obj1080_onLoad_runningActionsCount = 0;
var obj1080_onLoad_loopCount = 0;
...
obj1080_onLoad_actionGroup0 = function(){
	isLastActionGroup = false;
	if (isLastActionGroup) {
		window.obj1080_onLoad_activeActionGroupIndex = -1;
		$("#obj1080").trigger("obj1080_onLoad_ended");
		
		return;
	}
	window.obj1080_onLoad_activeActionGroupIndex = 0;
...
//	target: obj1080 
rotate_1083();
function rotate_1083() {
	window.obj1080_onLoad_runningActionsCount = obj1080_onLoad_runningActionsCount + 1;
	
	var targetObjectId = "#obj1080";
	var targetObject = $(targetObjectId)[0];
	var targetObjectIdString = 'obj1080';
	...
	if (isInfinite) { rotate_1083_completed(); }
	//TweenMax.to(targetObjectId, 1, {rotation:'+=' + rotationToDegrees, transformOrigin: transformOriginX + ' ' + transformOriginY, ease:'' + rotationEasing + '', repeat:0, onComplete:rotate_1083_completed});
	
	var timesRun = 0;
	timesRun += 1;
	rotate(targetObjectIdString,timesRun,howManyTimes,rotationToDegrees,rotationSpeedMS,rotationEasing,transformOriginX,transformOriginY,rotate_1083_completed);
...
function rotate_1083_completed() {
	setTimeout(function() {
		window.obj1080_onLoad_runningActionsCount = window.obj1080_onLoad_runningActionsCount - 1;
if (window.obj1080_onLoad_runningActionsCount == 0) {
	obj1080_onLoad_actionGroup1();
}
	}, 1);
}
...
function scale_1084() {
	...
	var isInfinite = false;
	if (isInfinite) { 
		scale_1084_completed(); 
	}
		var timesRun = 0;
	timesRun += 1;
	scale(targetObjectIdString,timesRun,howManyTimes,scaleXValue,scaleYValue,effectDurationMS,effectEasing,transformOriginX,transformOriginY,scaleMode,scale_1084_completed);
	if (howManyTimes > 1 || isInfinite) {
...
obj1080_onLoad_actionGroup1 = function(){
	isLastActionGroup = false;
	if (isLastActionGroup) {
		window.obj1080_onLoad_activeActionGroupIndex = -1;
		$("#obj1080").trigger("obj1080_onLoad_ended");
...
function rotate_1085() {
	...
	var isInfinite = false;
	if (isInfinite) { rotate_1085_completed(); }
	//TweenMax.to(targetObjectId, 1.5, {rotation:'+=' + rotationToDegrees, transformOrigin: transformOriginX + ' ' + transformOriginY, ease:'' + rotationEasing + '', repeat:0, onComplete:rotate_1085_completed});
	
	var timesRun = 0;
	timesRun += 1;
	rotate(targetObjectIdString,timesRun,howManyTimes,rotationToDegrees,rotationSpeedMS,rotationEasing,transformOriginX,transformOriginY,rotate_1085_completed);
	if (howManyTimes > 1 || isInfinite) {
		var rotateInterval = setInterval(function(){
			timesRun += 1;
			rotate(targetObjectIdString,timesRun,howManyTimes,rotationToDegrees,rotationSpeedMS,rotationEasing,transformOriginX,transformOriginY,rotate_1085_completed);
...
function rotate_1085_completed() {
	setTimeout(function() {
		window.obj1080_onLoad_runningActionsCount = window.obj1080_onLoad_runningActionsCount - 1;
if (window.obj1080_onLoad_runningActionsCount == 0) {
	obj1080_onLoad_actionGroup2();
}
	}, 1);
}
...
function scale_1086() {
	...
	var isInfinite = false;
	if (isInfinite) { 
		scale_1086_completed(); 
	}
		var timesRun = 0;
	timesRun += 1;
	scale(targetObjectIdString,timesRun,howManyTimes,scaleXValue,scaleYValue,effectDurationMS,effectEasing,transformOriginX,transformOriginY,scaleMode,scale_1086_completed);
	if (howManyTimes > 1 || isInfinite) {
		var scaleInterval = setInterval(function(){
			timesRun += 1;
				scale(targetObjectIdString,timesRun,howManyTimes,scaleXValue,scaleYValue,effectDurationMS,effectEasing,transformOriginX,transformOriginY,scaleMode,scale_1086_completed);
...
obj1080_onLoad_actionGroup2 = function(){
	isLastActionGroup = false;
	if (isLastActionGroup) {
		window.obj1080_onLoad_activeActionGroupIndex = -1;
		$("#obj1080").trigger("obj1080_onLoad_ended");
	...
	window.obj1080_onLoad_activeActionGroupIndex = 2;
...
//	action: loop
loop_obj1080_onLoad();
function loop_obj1080_onLoad() {
	var loopCount = 0;
	window.obj1080_onLoad_loopCount = window.obj1080_onLoad_loopCount + 1;
	if (loopCount != 0 && window.obj1080_onLoad_loopCount > loopCount) {
		window.obj1080_onLoad_loopCount = 0
		obj1080_onLoad_actionGroup3();
	} else {
		obj1080_onLoad_actionGroup0();
	}
}
...
obj1080_onLoad_actionGroup3 = function(){
	...
	window.obj1080_onLoad_activeActionGroupIndex = 3;
...
$(window).bind(PubCoder.Events.PageReady, function(event) {
	if (window.obj1080_onLoad_activeActionGroupIndex != -1) return;
var obj1080_onLoad_runningActionsCount = 0;
var obj1080_onLoad_loopCount = 0;
obj1080_onLoad_actionGroup0();
});
