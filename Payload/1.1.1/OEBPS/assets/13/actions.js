...
pubcoder.page.id = pubcoder.page.id || 54;
 ...
 * 
 */
var obj1112_onLoad_activeActionGroupIndex = -1;
var obj1112_onLoad_runningActionsCount = 0;
var obj1112_onLoad_loopCount = 0;
...
obj1112_onLoad_actionGroup0 = function(){
	isLastActionGroup = false;
	if (isLastActionGroup) {
		window.obj1112_onLoad_activeActionGroupIndex = -1;
		$("#obj1112").trigger("obj1112_onLoad_ended");
		
		return;
	}
	window.obj1112_onLoad_activeActionGroupIndex = 0;
...
//	target: obj1112 
rotate_1115();
function rotate_1115() {
	window.obj1112_onLoad_runningActionsCount = obj1112_onLoad_runningActionsCount + 1;
	
	var targetObjectId = "#obj1112";
	var targetObject = $(targetObjectId)[0];
	var targetObjectIdString = 'obj1112';
	...
	if (isInfinite) { rotate_1115_completed(); }
	//TweenMax.to(targetObjectId, 1, {rotation:'+=' + rotationToDegrees, transformOrigin: transformOriginX + ' ' + transformOriginY, ease:'' + rotationEasing + '', repeat:0, onComplete:rotate_1115_completed});
	
	var timesRun = 0;
	timesRun += 1;
	rotate(targetObjectIdString,timesRun,howManyTimes,rotationToDegrees,rotationSpeedMS,rotationEasing,transformOriginX,transformOriginY,rotate_1115_completed);
...
function rotate_1115_completed() {
	setTimeout(function() {
		window.obj1112_onLoad_runningActionsCount = window.obj1112_onLoad_runningActionsCount - 1;
if (window.obj1112_onLoad_runningActionsCount == 0) {
	obj1112_onLoad_actionGroup1();
}
	}, 1);
}
...
function scale_1116() {
	...
	var isInfinite = false;
	if (isInfinite) { 
		scale_1116_completed(); 
	}
		var timesRun = 0;
	timesRun += 1;
	scale(targetObjectIdString,timesRun,howManyTimes,scaleXValue,scaleYValue,effectDurationMS,effectEasing,transformOriginX,transformOriginY,scaleMode,scale_1116_completed);
	if (howManyTimes > 1 || isInfinite) {
...
obj1112_onLoad_actionGroup1 = function(){
	isLastActionGroup = false;
	if (isLastActionGroup) {
		window.obj1112_onLoad_activeActionGroupIndex = -1;
		$("#obj1112").trigger("obj1112_onLoad_ended");
...
function rotate_1117() {
	...
	var isInfinite = false;
	if (isInfinite) { rotate_1117_completed(); }
	//TweenMax.to(targetObjectId, 1.5, {rotation:'+=' + rotationToDegrees, transformOrigin: transformOriginX + ' ' + transformOriginY, ease:'' + rotationEasing + '', repeat:0, onComplete:rotate_1117_completed});
	
	var timesRun = 0;
	timesRun += 1;
	rotate(targetObjectIdString,timesRun,howManyTimes,rotationToDegrees,rotationSpeedMS,rotationEasing,transformOriginX,transformOriginY,rotate_1117_completed);
	if (howManyTimes > 1 || isInfinite) {
		var rotateInterval = setInterval(function(){
			timesRun += 1;
			rotate(targetObjectIdString,timesRun,howManyTimes,rotationToDegrees,rotationSpeedMS,rotationEasing,transformOriginX,transformOriginY,rotate_1117_completed);
...
function rotate_1117_completed() {
	setTimeout(function() {
		window.obj1112_onLoad_runningActionsCount = window.obj1112_onLoad_runningActionsCount - 1;
if (window.obj1112_onLoad_runningActionsCount == 0) {
	obj1112_onLoad_actionGroup2();
}
	}, 1);
}
...
function scale_1118() {
	...
	var isInfinite = false;
	if (isInfinite) { 
		scale_1118_completed(); 
	}
		var timesRun = 0;
	timesRun += 1;
	scale(targetObjectIdString,timesRun,howManyTimes,scaleXValue,scaleYValue,effectDurationMS,effectEasing,transformOriginX,transformOriginY,scaleMode,scale_1118_completed);
	if (howManyTimes > 1 || isInfinite) {
		var scaleInterval = setInterval(function(){
			timesRun += 1;
				scale(targetObjectIdString,timesRun,howManyTimes,scaleXValue,scaleYValue,effectDurationMS,effectEasing,transformOriginX,transformOriginY,scaleMode,scale_1118_completed);
...
obj1112_onLoad_actionGroup2 = function(){
	isLastActionGroup = false;
	if (isLastActionGroup) {
		window.obj1112_onLoad_activeActionGroupIndex = -1;
		$("#obj1112").trigger("obj1112_onLoad_ended");
	...
	window.obj1112_onLoad_activeActionGroupIndex = 2;
...
//	action: loop
loop_obj1112_onLoad();
function loop_obj1112_onLoad() {
	var loopCount = 0;
	window.obj1112_onLoad_loopCount = window.obj1112_onLoad_loopCount + 1;
	if (loopCount != 0 && window.obj1112_onLoad_loopCount > loopCount) {
		window.obj1112_onLoad_loopCount = 0
		obj1112_onLoad_actionGroup3();
	} else {
		obj1112_onLoad_actionGroup0();
	}
}
...
obj1112_onLoad_actionGroup3 = function(){
	...
	window.obj1112_onLoad_activeActionGroupIndex = 3;
...
$(window).bind(PubCoder.Events.PageReady, function(event) {
	if (window.obj1112_onLoad_activeActionGroupIndex != -1) return;
var obj1112_onLoad_runningActionsCount = 0;
var obj1112_onLoad_loopCount = 0;
obj1112_onLoad_actionGroup0();
});
