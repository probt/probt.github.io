...
pubcoder.page.id = pubcoder.page.id || 30;
 ...
 * 
 */
var obj1064_onLoad_activeActionGroupIndex = -1;
var obj1064_onLoad_runningActionsCount = 0;
var obj1064_onLoad_loopCount = 0;
...
obj1064_onLoad_actionGroup0 = function(){
	isLastActionGroup = false;
	if (isLastActionGroup) {
		window.obj1064_onLoad_activeActionGroupIndex = -1;
		$("#obj1064").trigger("obj1064_onLoad_ended");
		
		return;
	}
	window.obj1064_onLoad_activeActionGroupIndex = 0;
...
//	target: obj1064 
rotate_1067();
function rotate_1067() {
	window.obj1064_onLoad_runningActionsCount = obj1064_onLoad_runningActionsCount + 1;
	
	var targetObjectId = "#obj1064";
	var targetObject = $(targetObjectId)[0];
	var targetObjectIdString = 'obj1064';
	...
	if (isInfinite) { rotate_1067_completed(); }
	//TweenMax.to(targetObjectId, 1, {rotation:'+=' + rotationToDegrees, transformOrigin: transformOriginX + ' ' + transformOriginY, ease:'' + rotationEasing + '', repeat:0, onComplete:rotate_1067_completed});
	
	var timesRun = 0;
	timesRun += 1;
	rotate(targetObjectIdString,timesRun,howManyTimes,rotationToDegrees,rotationSpeedMS,rotationEasing,transformOriginX,transformOriginY,rotate_1067_completed);
...
function rotate_1067_completed() {
	setTimeout(function() {
		window.obj1064_onLoad_runningActionsCount = window.obj1064_onLoad_runningActionsCount - 1;
if (window.obj1064_onLoad_runningActionsCount == 0) {
	obj1064_onLoad_actionGroup1();
}
	}, 1);
}
...
function scale_1068() {
	...
	var isInfinite = false;
	if (isInfinite) { 
		scale_1068_completed(); 
	}
		var timesRun = 0;
	timesRun += 1;
	scale(targetObjectIdString,timesRun,howManyTimes,scaleXValue,scaleYValue,effectDurationMS,effectEasing,transformOriginX,transformOriginY,scaleMode,scale_1068_completed);
	if (howManyTimes > 1 || isInfinite) {
...
obj1064_onLoad_actionGroup1 = function(){
	isLastActionGroup = false;
	if (isLastActionGroup) {
		window.obj1064_onLoad_activeActionGroupIndex = -1;
		$("#obj1064").trigger("obj1064_onLoad_ended");
...
function rotate_1069() {
	...
	var isInfinite = false;
	if (isInfinite) { rotate_1069_completed(); }
	//TweenMax.to(targetObjectId, 1.5, {rotation:'+=' + rotationToDegrees, transformOrigin: transformOriginX + ' ' + transformOriginY, ease:'' + rotationEasing + '', repeat:0, onComplete:rotate_1069_completed});
	
	var timesRun = 0;
	timesRun += 1;
	rotate(targetObjectIdString,timesRun,howManyTimes,rotationToDegrees,rotationSpeedMS,rotationEasing,transformOriginX,transformOriginY,rotate_1069_completed);
	if (howManyTimes > 1 || isInfinite) {
		var rotateInterval = setInterval(function(){
			timesRun += 1;
			rotate(targetObjectIdString,timesRun,howManyTimes,rotationToDegrees,rotationSpeedMS,rotationEasing,transformOriginX,transformOriginY,rotate_1069_completed);
...
function rotate_1069_completed() {
	setTimeout(function() {
		window.obj1064_onLoad_runningActionsCount = window.obj1064_onLoad_runningActionsCount - 1;
if (window.obj1064_onLoad_runningActionsCount == 0) {
	obj1064_onLoad_actionGroup2();
}
	}, 1);
}
...
function scale_1070() {
	...
	var isInfinite = false;
	if (isInfinite) { 
		scale_1070_completed(); 
	}
		var timesRun = 0;
	timesRun += 1;
	scale(targetObjectIdString,timesRun,howManyTimes,scaleXValue,scaleYValue,effectDurationMS,effectEasing,transformOriginX,transformOriginY,scaleMode,scale_1070_completed);
	if (howManyTimes > 1 || isInfinite) {
		var scaleInterval = setInterval(function(){
			timesRun += 1;
				scale(targetObjectIdString,timesRun,howManyTimes,scaleXValue,scaleYValue,effectDurationMS,effectEasing,transformOriginX,transformOriginY,scaleMode,scale_1070_completed);
...
obj1064_onLoad_actionGroup2 = function(){
	isLastActionGroup = false;
	if (isLastActionGroup) {
		window.obj1064_onLoad_activeActionGroupIndex = -1;
		$("#obj1064").trigger("obj1064_onLoad_ended");
	...
	window.obj1064_onLoad_activeActionGroupIndex = 2;
...
//	action: loop
loop_obj1064_onLoad();
function loop_obj1064_onLoad() {
	var loopCount = 0;
	window.obj1064_onLoad_loopCount = window.obj1064_onLoad_loopCount + 1;
	if (loopCount != 0 && window.obj1064_onLoad_loopCount > loopCount) {
		window.obj1064_onLoad_loopCount = 0
		obj1064_onLoad_actionGroup3();
	} else {
		obj1064_onLoad_actionGroup0();
	}
}
...
obj1064_onLoad_actionGroup3 = function(){
	...
	window.obj1064_onLoad_activeActionGroupIndex = 3;
...
$(window).bind(PubCoder.Events.PageReady, function(event) {
	if (window.obj1064_onLoad_activeActionGroupIndex != -1) return;
var obj1064_onLoad_runningActionsCount = 0;
var obj1064_onLoad_loopCount = 0;
obj1064_onLoad_actionGroup0();
});
