 ...
 * 
 */
var obj1040_onLoad_activeActionGroupIndex = -1;
var obj1040_onLoad_runningActionsCount = 0;
var obj1040_onLoad_loopCount = 0;
...
obj1040_onLoad_actionGroup0 = function(){
	isLastActionGroup = false;
	if (isLastActionGroup) {
		window.obj1040_onLoad_activeActionGroupIndex = -1;
		$("#obj1040").trigger("obj1040_onLoad_ended");
		
		return;
	}
	window.obj1040_onLoad_activeActionGroupIndex = 0;
...
//	target: obj1040 
rotate_1043();
function rotate_1043() {
	window.obj1040_onLoad_runningActionsCount = obj1040_onLoad_runningActionsCount + 1;
	
	var targetObjectId = "#obj1040";
	var targetObject = $(targetObjectId)[0];
	var targetObjectIdString = 'obj1040';
	...
	if (isInfinite) { rotate_1043_completed(); }
	//TweenMax.to(targetObjectId, 1, {rotation:'+=' + rotationToDegrees, transformOrigin: transformOriginX + ' ' + transformOriginY, ease:'' + rotationEasing + '', repeat:0, onComplete:rotate_1043_completed});
	
	var timesRun = 0;
	timesRun += 1;
	rotate(targetObjectIdString,timesRun,howManyTimes,rotationToDegrees,rotationSpeedMS,rotationEasing,transformOriginX,transformOriginY,rotate_1043_completed);
...
function rotate_1043_completed() {
	setTimeout(function() {
		window.obj1040_onLoad_runningActionsCount = window.obj1040_onLoad_runningActionsCount - 1;
if (window.obj1040_onLoad_runningActionsCount == 0) {
	obj1040_onLoad_actionGroup1();
}
	}, 1);
}
...
function scale_1046() {
	...
	var isInfinite = false;
	if (isInfinite) { 
		scale_1046_completed(); 
	}
		var timesRun = 0;
	timesRun += 1;
	scale(targetObjectIdString,timesRun,howManyTimes,scaleXValue,scaleYValue,effectDurationMS,effectEasing,transformOriginX,transformOriginY,scaleMode,scale_1046_completed);
	if (howManyTimes > 1 || isInfinite) {
...
obj1040_onLoad_actionGroup1 = function(){
	isLastActionGroup = false;
	if (isLastActionGroup) {
		window.obj1040_onLoad_activeActionGroupIndex = -1;
		$("#obj1040").trigger("obj1040_onLoad_ended");
...
function rotate_1044() {
	...
	var isInfinite = false;
	if (isInfinite) { rotate_1044_completed(); }
	//TweenMax.to(targetObjectId, 1.5, {rotation:'+=' + rotationToDegrees, transformOrigin: transformOriginX + ' ' + transformOriginY, ease:'' + rotationEasing + '', repeat:0, onComplete:rotate_1044_completed});
	
	var timesRun = 0;
	timesRun += 1;
	rotate(targetObjectIdString,timesRun,howManyTimes,rotationToDegrees,rotationSpeedMS,rotationEasing,transformOriginX,transformOriginY,rotate_1044_completed);
	if (howManyTimes > 1 || isInfinite) {
		var rotateInterval = setInterval(function(){
			timesRun += 1;
			rotate(targetObjectIdString,timesRun,howManyTimes,rotationToDegrees,rotationSpeedMS,rotationEasing,transformOriginX,transformOriginY,rotate_1044_completed);
...
function rotate_1044_completed() {
	setTimeout(function() {
		window.obj1040_onLoad_runningActionsCount = window.obj1040_onLoad_runningActionsCount - 1;
if (window.obj1040_onLoad_runningActionsCount == 0) {
	obj1040_onLoad_actionGroup2();
}
	}, 1);
}
...
function scale_1047() {
	...
	var isInfinite = false;
	if (isInfinite) { 
		scale_1047_completed(); 
	}
		var timesRun = 0;
	timesRun += 1;
	scale(targetObjectIdString,timesRun,howManyTimes,scaleXValue,scaleYValue,effectDurationMS,effectEasing,transformOriginX,transformOriginY,scaleMode,scale_1047_completed);
	if (howManyTimes > 1 || isInfinite) {
		var scaleInterval = setInterval(function(){
			timesRun += 1;
				scale(targetObjectIdString,timesRun,howManyTimes,scaleXValue,scaleYValue,effectDurationMS,effectEasing,transformOriginX,transformOriginY,scaleMode,scale_1047_completed);
...
obj1040_onLoad_actionGroup2 = function(){
	isLastActionGroup = false;
	if (isLastActionGroup) {
		window.obj1040_onLoad_activeActionGroupIndex = -1;
		$("#obj1040").trigger("obj1040_onLoad_ended");
	...
	window.obj1040_onLoad_activeActionGroupIndex = 2;
...
//	action: loop
loop_obj1040_onLoad();
function loop_obj1040_onLoad() {
	var loopCount = 0;
	window.obj1040_onLoad_loopCount = window.obj1040_onLoad_loopCount + 1;
	if (loopCount != 0 && window.obj1040_onLoad_loopCount > loopCount) {
		window.obj1040_onLoad_loopCount = 0
		obj1040_onLoad_actionGroup3();
	} else {
		obj1040_onLoad_actionGroup0();
	}
}
...
obj1040_onLoad_actionGroup3 = function(){
	...
	window.obj1040_onLoad_activeActionGroupIndex = 3;
...
$(window).bind(PubCoder.Events.PageReady, function(event) {
	if (window.obj1040_onLoad_activeActionGroupIndex != -1) return;
var obj1040_onLoad_runningActionsCount = 0;
var obj1040_onLoad_loopCount = 0;
obj1040_onLoad_actionGroup0();
});
