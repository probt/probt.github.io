...
pubcoder.page.id = pubcoder.page.id || 15;
 ...
 * 
 */
var obj1034_onLoad_activeActionGroupIndex = -1;
var obj1034_onLoad_runningActionsCount = 0;
var obj1034_onLoad_loopCount = 0;
...
obj1034_onLoad_actionGroup0 = function(){
	isLastActionGroup = false;
	if (isLastActionGroup) {
		window.obj1034_onLoad_activeActionGroupIndex = -1;
		$("#obj1034").trigger("obj1034_onLoad_ended");
		
		return;
	}
	window.obj1034_onLoad_activeActionGroupIndex = 0;
...
scale_1037();
function scale_1037() {
	window.obj1034_onLoad_runningActionsCount = obj1034_onLoad_runningActionsCount + 1;
	
	var targetObjectId = "#obj1034";
	var targetObject = $(targetObjectId)[0];
	var targetObjectIdString = 'obj1034';
	...
	if (isInfinite) { 
		scale_1037_completed(); 
	}
		var timesRun = 0;
	timesRun += 1;
	scale(targetObjectIdString,timesRun,howManyTimes,scaleXValue,scaleYValue,effectDurationMS,effectEasing,transformOriginX,transformOriginY,scaleMode,scale_1037_completed);
...
function scale_1037_completed() {
	setTimeout(function() {
		window.obj1034_onLoad_runningActionsCount = window.obj1034_onLoad_runningActionsCount - 1;
if (window.obj1034_onLoad_runningActionsCount == 0) {
	obj1034_onLoad_actionGroup1();
}
	}, 1);
}
...
obj1034_onLoad_actionGroup1 = function(){
	isLastActionGroup = false;
	if (isLastActionGroup) {
		window.obj1034_onLoad_activeActionGroupIndex = -1;
		$("#obj1034").trigger("obj1034_onLoad_ended");
...
function scale_1038() {
	...
	var isInfinite = false;
	if (isInfinite) { 
		scale_1038_completed(); 
	}
		var timesRun = 0;
	timesRun += 1;
	scale(targetObjectIdString,timesRun,howManyTimes,scaleXValue,scaleYValue,effectDurationMS,effectEasing,transformOriginX,transformOriginY,scaleMode,scale_1038_completed);
	if (howManyTimes > 1 || isInfinite) {
		var scaleInterval = setInterval(function(){
			timesRun += 1;
				scale(targetObjectIdString,timesRun,howManyTimes,scaleXValue,scaleYValue,effectDurationMS,effectEasing,transformOriginX,transformOriginY,scaleMode,scale_1038_completed);
...
function scale_1038_completed() {
	setTimeout(function() {
		window.obj1034_onLoad_runningActionsCount = window.obj1034_onLoad_runningActionsCount - 1;
if (window.obj1034_onLoad_runningActionsCount == 0) {
	obj1034_onLoad_actionGroup2();
}
	}, 1);
}
...
obj1034_onLoad_actionGroup2 = function(){
	isLastActionGroup = false;
	if (isLastActionGroup) {
		window.obj1034_onLoad_activeActionGroupIndex = -1;
		$("#obj1034").trigger("obj1034_onLoad_ended");
	...
	window.obj1034_onLoad_activeActionGroupIndex = 2;
...
//	action: loop
loop_obj1034_onLoad();
function loop_obj1034_onLoad() {
	var loopCount = 0;
	window.obj1034_onLoad_loopCount = window.obj1034_onLoad_loopCount + 1;
	if (loopCount != 0 && window.obj1034_onLoad_loopCount > loopCount) {
		window.obj1034_onLoad_loopCount = 0
		obj1034_onLoad_actionGroup3();
	} else {
		obj1034_onLoad_actionGroup0();
	}
}
...
obj1034_onLoad_actionGroup3 = function(){
	...
	window.obj1034_onLoad_activeActionGroupIndex = 3;
...
$(window).bind(PubCoder.Events.PageReady, function(event) {
	if (window.obj1034_onLoad_activeActionGroupIndex != -1) return;
var obj1034_onLoad_runningActionsCount = 0;
var obj1034_onLoad_loopCount = 0;
obj1034_onLoad_actionGroup0();
});
