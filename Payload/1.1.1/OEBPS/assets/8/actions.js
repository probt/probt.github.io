...
pubcoder.page.id = pubcoder.page.id || 34;
 ...
 * 
 */
var obj1072_onLoad_activeActionGroupIndex = -1;
var obj1072_onLoad_runningActionsCount = 0;
var obj1072_onLoad_loopCount = 0;
...
obj1072_onLoad_actionGroup0 = function(){
	isLastActionGroup = false;
	if (isLastActionGroup) {
		window.obj1072_onLoad_activeActionGroupIndex = -1;
		$("#obj1072").trigger("obj1072_onLoad_ended");
		
		return;
	}
	window.obj1072_onLoad_activeActionGroupIndex = 0;
...
//	target: obj1072 
rotate_1075();
function rotate_1075() {
	window.obj1072_onLoad_runningActionsCount = obj1072_onLoad_runningActionsCount + 1;
	
	var targetObjectId = "#obj1072";
	var targetObject = $(targetObjectId)[0];
	var targetObjectIdString = 'obj1072';
	...
	if (isInfinite) { rotate_1075_completed(); }
	//TweenMax.to(targetObjectId, 1, {rotation:'+=' + rotationToDegrees, transformOrigin: transformOriginX + ' ' + transformOriginY, ease:'' + rotationEasing + '', repeat:0, onComplete:rotate_1075_completed});
	
	var timesRun = 0;
	timesRun += 1;
	rotate(targetObjectIdString,timesRun,howManyTimes,rotationToDegrees,rotationSpeedMS,rotationEasing,transformOriginX,transformOriginY,rotate_1075_completed);
...
function rotate_1075_completed() {
	setTimeout(function() {
		window.obj1072_onLoad_runningActionsCount = window.obj1072_onLoad_runningActionsCount - 1;
if (window.obj1072_onLoad_runningActionsCount == 0) {
	obj1072_onLoad_actionGroup1();
}
	}, 1);
}
...
function scale_1076() {
	...
	var isInfinite = false;
	if (isInfinite) { 
		scale_1076_completed(); 
	}
		var timesRun = 0;
	timesRun += 1;
	scale(targetObjectIdString,timesRun,howManyTimes,scaleXValue,scaleYValue,effectDurationMS,effectEasing,transformOriginX,transformOriginY,scaleMode,scale_1076_completed);
	if (howManyTimes > 1 || isInfinite) {
...
obj1072_onLoad_actionGroup1 = function(){
	isLastActionGroup = false;
	if (isLastActionGroup) {
		window.obj1072_onLoad_activeActionGroupIndex = -1;
		$("#obj1072").trigger("obj1072_onLoad_ended");
...
function rotate_1077() {
	...
	var isInfinite = false;
	if (isInfinite) { rotate_1077_completed(); }
	//TweenMax.to(targetObjectId, 1.5, {rotation:'+=' + rotationToDegrees, transformOrigin: transformOriginX + ' ' + transformOriginY, ease:'' + rotationEasing + '', repeat:0, onComplete:rotate_1077_completed});
	
	var timesRun = 0;
	timesRun += 1;
	rotate(targetObjectIdString,timesRun,howManyTimes,rotationToDegrees,rotationSpeedMS,rotationEasing,transformOriginX,transformOriginY,rotate_1077_completed);
	if (howManyTimes > 1 || isInfinite) {
		var rotateInterval = setInterval(function(){
			timesRun += 1;
			rotate(targetObjectIdString,timesRun,howManyTimes,rotationToDegrees,rotationSpeedMS,rotationEasing,transformOriginX,transformOriginY,rotate_1077_completed);
...
function rotate_1077_completed() {
	setTimeout(function() {
		window.obj1072_onLoad_runningActionsCount = window.obj1072_onLoad_runningActionsCount - 1;
if (window.obj1072_onLoad_runningActionsCount == 0) {
	obj1072_onLoad_actionGroup2();
}
	}, 1);
}
...
function scale_1078() {
	...
	var isInfinite = false;
	if (isInfinite) { 
		scale_1078_completed(); 
	}
		var timesRun = 0;
	timesRun += 1;
	scale(targetObjectIdString,timesRun,howManyTimes,scaleXValue,scaleYValue,effectDurationMS,effectEasing,transformOriginX,transformOriginY,scaleMode,scale_1078_completed);
	if (howManyTimes > 1 || isInfinite) {
		var scaleInterval = setInterval(function(){
			timesRun += 1;
				scale(targetObjectIdString,timesRun,howManyTimes,scaleXValue,scaleYValue,effectDurationMS,effectEasing,transformOriginX,transformOriginY,scaleMode,scale_1078_completed);
...
obj1072_onLoad_actionGroup2 = function(){
	isLastActionGroup = false;
	if (isLastActionGroup) {
		window.obj1072_onLoad_activeActionGroupIndex = -1;
		$("#obj1072").trigger("obj1072_onLoad_ended");
	...
	window.obj1072_onLoad_activeActionGroupIndex = 2;
...
//	action: loop
loop_obj1072_onLoad();
function loop_obj1072_onLoad() {
	var loopCount = 0;
	window.obj1072_onLoad_loopCount = window.obj1072_onLoad_loopCount + 1;
	if (loopCount != 0 && window.obj1072_onLoad_loopCount > loopCount) {
		window.obj1072_onLoad_loopCount = 0
		obj1072_onLoad_actionGroup3();
	} else {
		obj1072_onLoad_actionGroup0();
	}
}
...
obj1072_onLoad_actionGroup3 = function(){
	...
	window.obj1072_onLoad_activeActionGroupIndex = 3;
...
$(window).bind(PubCoder.Events.PageReady, function(event) {
	if (window.obj1072_onLoad_activeActionGroupIndex != -1) return;
var obj1072_onLoad_runningActionsCount = 0;
var obj1072_onLoad_loopCount = 0;
obj1072_onLoad_actionGroup0();
});
