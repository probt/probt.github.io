...
pubcoder.page.id = pubcoder.page.id || 46;
 ...
 * 
 */
var obj1096_onLoad_activeActionGroupIndex = -1;
var obj1096_onLoad_runningActionsCount = 0;
var obj1096_onLoad_loopCount = 0;
...
obj1096_onLoad_actionGroup0 = function(){
	isLastActionGroup = false;
	if (isLastActionGroup) {
		window.obj1096_onLoad_activeActionGroupIndex = -1;
		$("#obj1096").trigger("obj1096_onLoad_ended");
		
		return;
	}
	window.obj1096_onLoad_activeActionGroupIndex = 0;
...
//	target: obj1096 
rotate_1099();
function rotate_1099() {
	window.obj1096_onLoad_runningActionsCount = obj1096_onLoad_runningActionsCount + 1;
	
	var targetObjectId = "#obj1096";
	var targetObject = $(targetObjectId)[0];
	var targetObjectIdString = 'obj1096';
	...
	if (isInfinite) { rotate_1099_completed(); }
	//TweenMax.to(targetObjectId, 1, {rotation:'+=' + rotationToDegrees, transformOrigin: transformOriginX + ' ' + transformOriginY, ease:'' + rotationEasing + '', repeat:0, onComplete:rotate_1099_completed});
	
	var timesRun = 0;
	timesRun += 1;
	rotate(targetObjectIdString,timesRun,howManyTimes,rotationToDegrees,rotationSpeedMS,rotationEasing,transformOriginX,transformOriginY,rotate_1099_completed);
...
function rotate_1099_completed() {
	setTimeout(function() {
		window.obj1096_onLoad_runningActionsCount = window.obj1096_onLoad_runningActionsCount - 1;
if (window.obj1096_onLoad_runningActionsCount == 0) {
	obj1096_onLoad_actionGroup1();
}
	}, 1);
}
...
function scale_1100() {
	...
	var isInfinite = false;
	if (isInfinite) { 
		scale_1100_completed(); 
	}
		var timesRun = 0;
	timesRun += 1;
	scale(targetObjectIdString,timesRun,howManyTimes,scaleXValue,scaleYValue,effectDurationMS,effectEasing,transformOriginX,transformOriginY,scaleMode,scale_1100_completed);
	if (howManyTimes > 1 || isInfinite) {
...
obj1096_onLoad_actionGroup1 = function(){
	isLastActionGroup = false;
	if (isLastActionGroup) {
		window.obj1096_onLoad_activeActionGroupIndex = -1;
		$("#obj1096").trigger("obj1096_onLoad_ended");
...
function rotate_1101() {
	...
	var isInfinite = false;
	if (isInfinite) { rotate_1101_completed(); }
	//TweenMax.to(targetObjectId, 1.5, {rotation:'+=' + rotationToDegrees, transformOrigin: transformOriginX + ' ' + transformOriginY, ease:'' + rotationEasing + '', repeat:0, onComplete:rotate_1101_completed});
	
	var timesRun = 0;
	timesRun += 1;
	rotate(targetObjectIdString,timesRun,howManyTimes,rotationToDegrees,rotationSpeedMS,rotationEasing,transformOriginX,transformOriginY,rotate_1101_completed);
	if (howManyTimes > 1 || isInfinite) {
		var rotateInterval = setInterval(function(){
			timesRun += 1;
			rotate(targetObjectIdString,timesRun,howManyTimes,rotationToDegrees,rotationSpeedMS,rotationEasing,transformOriginX,transformOriginY,rotate_1101_completed);
...
function rotate_1101_completed() {
	setTimeout(function() {
		window.obj1096_onLoad_runningActionsCount = window.obj1096_onLoad_runningActionsCount - 1;
if (window.obj1096_onLoad_runningActionsCount == 0) {
	obj1096_onLoad_actionGroup2();
}
	}, 1);
}
...
function scale_1102() {
	...
	var isInfinite = false;
	if (isInfinite) { 
		scale_1102_completed(); 
	}
		var timesRun = 0;
	timesRun += 1;
	scale(targetObjectIdString,timesRun,howManyTimes,scaleXValue,scaleYValue,effectDurationMS,effectEasing,transformOriginX,transformOriginY,scaleMode,scale_1102_completed);
	if (howManyTimes > 1 || isInfinite) {
		var scaleInterval = setInterval(function(){
			timesRun += 1;
				scale(targetObjectIdString,timesRun,howManyTimes,scaleXValue,scaleYValue,effectDurationMS,effectEasing,transformOriginX,transformOriginY,scaleMode,scale_1102_completed);
...
obj1096_onLoad_actionGroup2 = function(){
	isLastActionGroup = false;
	if (isLastActionGroup) {
		window.obj1096_onLoad_activeActionGroupIndex = -1;
		$("#obj1096").trigger("obj1096_onLoad_ended");
	...
	window.obj1096_onLoad_activeActionGroupIndex = 2;
...
//	action: loop
loop_obj1096_onLoad();
function loop_obj1096_onLoad() {
	var loopCount = 0;
	window.obj1096_onLoad_loopCount = window.obj1096_onLoad_loopCount + 1;
	if (loopCount != 0 && window.obj1096_onLoad_loopCount > loopCount) {
		window.obj1096_onLoad_loopCount = 0
		obj1096_onLoad_actionGroup3();
	} else {
		obj1096_onLoad_actionGroup0();
	}
}
...
obj1096_onLoad_actionGroup3 = function(){
	...
	window.obj1096_onLoad_activeActionGroupIndex = 3;
...
$(window).bind(PubCoder.Events.PageReady, function(event) {
	if (window.obj1096_onLoad_activeActionGroupIndex != -1) return;
var obj1096_onLoad_runningActionsCount = 0;
var obj1096_onLoad_loopCount = 0;
obj1096_onLoad_actionGroup0();
});
...
$("#obj49").trigger('SCEventShow');
$("#obj1096").trigger('SCEventShow');
