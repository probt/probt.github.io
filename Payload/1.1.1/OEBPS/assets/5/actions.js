...
pubcoder.page.id = pubcoder.page.id || 23;
 ...
 * 
 */
var obj1048_onLoad_activeActionGroupIndex = -1;
var obj1048_onLoad_runningActionsCount = 0;
var obj1048_onLoad_loopCount = 0;
...
obj1048_onLoad_actionGroup0 = function(){
	isLastActionGroup = false;
	if (isLastActionGroup) {
		window.obj1048_onLoad_activeActionGroupIndex = -1;
		$("#obj1048").trigger("obj1048_onLoad_ended");
		
		return;
	}
	window.obj1048_onLoad_activeActionGroupIndex = 0;
...
function rotate_1051() {
	window.obj1048_onLoad_runningActionsCount = obj1048_onLoad_runningActionsCount + 1;
	
	var targetObjectId = "#obj1048";
	var targetObject = $(targetObjectId)[0];
	var targetObjectIdString = 'obj1048';
	...
	//TweenMax.to(targetObjectId, 1, {rotation:'+=' + rotationToDegrees, transformOrigin: transformOriginX + ' ' + transformOriginY, ease:'' + rotationEasing + '', repeat:0, onComplete:rotate_1051_completed});
...
function rotate_1051_completed() {
	setTimeout(function() {
		window.obj1048_onLoad_runningActionsCount = window.obj1048_onLoad_runningActionsCount - 1;
if (window.obj1048_onLoad_runningActionsCount == 0) {
	obj1048_onLoad_actionGroup1();
}
	}, 1);
}
...
function scale_1052() {
	...
	var isInfinite = false;
	if (isInfinite) { 
		scale_1052_completed(); 
	}
		var timesRun = 0;
	timesRun += 1;
	scale(targetObjectIdString,timesRun,howManyTimes,scaleXValue,scaleYValue,effectDurationMS,effectEasing,transformOriginX,transformOriginY,scaleMode,scale_1052_completed);
	if (howManyTimes > 1 || isInfinite) {
...
obj1048_onLoad_actionGroup1 = function(){
	isLastActionGroup = false;
	if (isLastActionGroup) {
		window.obj1048_onLoad_activeActionGroupIndex = -1;
		$("#obj1048").trigger("obj1048_onLoad_ended");
...
function rotate_1053() {
	...
	//TweenMax.to(targetObjectId, 1.5, {rotation:'+=' + rotationToDegrees, transformOrigin: transformOriginX + ' ' + transformOriginY, ease:'' + rotationEasing + '', repeat:0, onComplete:rotate_1053_completed});
...
function scale_1054() {
	...
	var isInfinite = false;
	if (isInfinite) { 
		scale_1054_completed(); 
	}
		var timesRun = 0;
	timesRun += 1;
	scale(targetObjectIdString,timesRun,howManyTimes,scaleXValue,scaleYValue,effectDurationMS,effectEasing,transformOriginX,transformOriginY,scaleMode,scale_1054_completed);
	if (howManyTimes > 1 || isInfinite) {
		var scaleInterval = setInterval(function(){
			timesRun += 1;
				scale(targetObjectIdString,timesRun,howManyTimes,scaleXValue,scaleYValue,effectDurationMS,effectEasing,transformOriginX,transformOriginY,scaleMode,scale_1054_completed);
...
obj1048_onLoad_actionGroup2 = function(){
	isLastActionGroup = false;
	if (isLastActionGroup) {
		window.obj1048_onLoad_activeActionGroupIndex = -1;
		$("#obj1048").trigger("obj1048_onLoad_ended");
	...
	window.obj1048_onLoad_activeActionGroupIndex = 2;
...
//	action: loop
loop_obj1048_onLoad();
function loop_obj1048_onLoad() {
	var loopCount = 0;
	window.obj1048_onLoad_loopCount = window.obj1048_onLoad_loopCount + 1;
	if (loopCount != 0 && window.obj1048_onLoad_loopCount > loopCount) {
		window.obj1048_onLoad_loopCount = 0
		obj1048_onLoad_actionGroup3();
	} else {
		obj1048_onLoad_actionGroup0();
	}
}
...
obj1048_onLoad_actionGroup3 = function(){
	...
	window.obj1048_onLoad_activeActionGroupIndex = 3;
...
$(window).bind(PubCoder.Events.PageReady, function(event) {
	if (window.obj1048_onLoad_activeActionGroupIndex != -1) return;
var obj1048_onLoad_runningActionsCount = 0;
var obj1048_onLoad_loopCount = 0;
obj1048_onLoad_actionGroup0();
});
