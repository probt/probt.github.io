...
pubcoder.page.id = pubcoder.page.id || 50;
 ...
 * 
 */
var obj1104_onLoad_activeActionGroupIndex = -1;
var obj1104_onLoad_runningActionsCount = 0;
var obj1104_onLoad_loopCount = 0;
...
obj1104_onLoad_actionGroup0 = function(){
	isLastActionGroup = false;
	if (isLastActionGroup) {
		window.obj1104_onLoad_activeActionGroupIndex = -1;
		$("#obj1104").trigger("obj1104_onLoad_ended");
		
		return;
	}
	window.obj1104_onLoad_activeActionGroupIndex = 0;
...
//	target: obj1104 
rotate_1107();
function rotate_1107() {
	window.obj1104_onLoad_runningActionsCount = obj1104_onLoad_runningActionsCount + 1;
	
	var targetObjectId = "#obj1104";
	var targetObject = $(targetObjectId)[0];
	var targetObjectIdString = 'obj1104';
	...
	if (isInfinite) { rotate_1107_completed(); }
	//TweenMax.to(targetObjectId, 1, {rotation:'+=' + rotationToDegrees, transformOrigin: transformOriginX + ' ' + transformOriginY, ease:'' + rotationEasing + '', repeat:0, onComplete:rotate_1107_completed});
	
	var timesRun = 0;
	timesRun += 1;
	rotate(targetObjectIdString,timesRun,howManyTimes,rotationToDegrees,rotationSpeedMS,rotationEasing,transformOriginX,transformOriginY,rotate_1107_completed);
...
function rotate_1107_completed() {
	setTimeout(function() {
		window.obj1104_onLoad_runningActionsCount = window.obj1104_onLoad_runningActionsCount - 1;
if (window.obj1104_onLoad_runningActionsCount == 0) {
	obj1104_onLoad_actionGroup1();
}
	}, 1);
}
...
function scale_1108() {
	...
	var isInfinite = false;
	if (isInfinite) { 
		scale_1108_completed(); 
	}
		var timesRun = 0;
	timesRun += 1;
	scale(targetObjectIdString,timesRun,howManyTimes,scaleXValue,scaleYValue,effectDurationMS,effectEasing,transformOriginX,transformOriginY,scaleMode,scale_1108_completed);
	if (howManyTimes > 1 || isInfinite) {
...
obj1104_onLoad_actionGroup1 = function(){
	isLastActionGroup = false;
	if (isLastActionGroup) {
		window.obj1104_onLoad_activeActionGroupIndex = -1;
		$("#obj1104").trigger("obj1104_onLoad_ended");
...
function rotate_1109() {
	...
	var isInfinite = false;
	if (isInfinite) { rotate_1109_completed(); }
	//TweenMax.to(targetObjectId, 1.5, {rotation:'+=' + rotationToDegrees, transformOrigin: transformOriginX + ' ' + transformOriginY, ease:'' + rotationEasing + '', repeat:0, onComplete:rotate_1109_completed});
	
	var timesRun = 0;
	timesRun += 1;
	rotate(targetObjectIdString,timesRun,howManyTimes,rotationToDegrees,rotationSpeedMS,rotationEasing,transformOriginX,transformOriginY,rotate_1109_completed);
	if (howManyTimes > 1 || isInfinite) {
		var rotateInterval = setInterval(function(){
			timesRun += 1;
			rotate(targetObjectIdString,timesRun,howManyTimes,rotationToDegrees,rotationSpeedMS,rotationEasing,transformOriginX,transformOriginY,rotate_1109_completed);
...
function rotate_1109_completed() {
	setTimeout(function() {
		window.obj1104_onLoad_runningActionsCount = window.obj1104_onLoad_runningActionsCount - 1;
if (window.obj1104_onLoad_runningActionsCount == 0) {
	obj1104_onLoad_actionGroup2();
}
	}, 1);
}
...
function scale_1110() {
	...
	var isInfinite = false;
	if (isInfinite) { 
		scale_1110_completed(); 
	}
		var timesRun = 0;
	timesRun += 1;
	scale(targetObjectIdString,timesRun,howManyTimes,scaleXValue,scaleYValue,effectDurationMS,effectEasing,transformOriginX,transformOriginY,scaleMode,scale_1110_completed);
	if (howManyTimes > 1 || isInfinite) {
		var scaleInterval = setInterval(function(){
			timesRun += 1;
				scale(targetObjectIdString,timesRun,howManyTimes,scaleXValue,scaleYValue,effectDurationMS,effectEasing,transformOriginX,transformOriginY,scaleMode,scale_1110_completed);
...
obj1104_onLoad_actionGroup2 = function(){
	isLastActionGroup = false;
	if (isLastActionGroup) {
		window.obj1104_onLoad_activeActionGroupIndex = -1;
		$("#obj1104").trigger("obj1104_onLoad_ended");
	...
	window.obj1104_onLoad_activeActionGroupIndex = 2;
...
//	action: loop
loop_obj1104_onLoad();
function loop_obj1104_onLoad() {
	var loopCount = 0;
	window.obj1104_onLoad_loopCount = window.obj1104_onLoad_loopCount + 1;
	if (loopCount != 0 && window.obj1104_onLoad_loopCount > loopCount) {
		window.obj1104_onLoad_loopCount = 0
		obj1104_onLoad_actionGroup3();
	} else {
		obj1104_onLoad_actionGroup0();
	}
}
...
obj1104_onLoad_actionGroup3 = function(){
	...
	window.obj1104_onLoad_activeActionGroupIndex = 3;
...
$(window).bind(PubCoder.Events.PageReady, function(event) {
	if (window.obj1104_onLoad_activeActionGroupIndex != -1) return;
var obj1104_onLoad_runningActionsCount = 0;
var obj1104_onLoad_loopCount = 0;
obj1104_onLoad_actionGroup0();
});
